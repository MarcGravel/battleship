...
class TestShip(unittest.TestCase):
    ...
    def test_horizontal_ship_placement_success(self):
    ...
    def test_horizontal_ship_placement_fail(self):
    ...
    def test_vertical_ship_placement_success(self):
    ...
    def test_vertical_ship_placement_fail(self):
